 ...
 * q - выйти из программы
 ...
 Список процессов должен атоматически обновляться каждые 10 секунд.
...
**Описание.** Запуска приложения с консоли пользователю необходимо ввести путь до диска, удаленного файла, либо папки, с которой был удален файл. После этого пользователь может ввести ключи, для другой работы программы. Ключи и их описания представлены ниже на изображении.

![Ключи](https://user-images.githubusercontent.com/71733287/204910355-b1ad8477-0948-435e-8b41-16bf28816d63.png)

После выхода со стартового меню начинается работа приложения. Для просмотра всех возможных функций в командную строку вводится соответсвующий символ.
